...
public partial class CMSFormControls_System_EnumSelector : FormEngineUserControl
{
    ...
    private SpecialFieldsDefinition mSpecialItems = null;
    ...
    public EnumDisplayTypeEnum DisplayType
    {
        get
        {
            return (EnumDisplayTypeEnum)GetValue<int>("DisplayType", 0);
        }
        set
        {
    ...
    public string ExcludedValues
    {
        get
        {
            return GetValue<string>("ExcludedValues", String.Empty);
        }
        set
        {
            SetValue("ExcludedValues", (string)value);
        }
    ...
    public SpecialFieldsDefinition SpecialItems
    {
        get
        {
            if (mSpecialItems == null)
            {
                ...
                mSpecialItems.LoadFromText(GetValue<string>("Items", String.Empty));
            }
