        ...
        <ContentTemplate>
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <asp:Panel runat="server" ID="pnlType" CssClass="radio-list-vertical">
                            ...
                            <cms:CMSRadioButton runat="server" ID="radMVC" ResourceString="URLPath.MVC"
                                GroupName="URL" AutoPostBack="true" />
                        </asp:Panel>
                    </div>
                </div>
                ...
                <asp:PlaceHolder runat="server" ID="plcMVC">
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblController" ResourceString="MVC.DefaultController"
                                DisplayColon="true" AssociatedControlID="txtController" />
                        </div>
                        <div class="editing-form-value-cell">
                            <cms:CMSTextBox runat="server" ID="txtController" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <cms:LocalizedLabel CssClass="control-label" runat="server" ID="LocalizedLabel1" ResourceString="MVC.DefaultAction"
                                DisplayColon="true" AssociatedControlID="txtAction" />
                        </div>
                        <div class="editing-form-value-cell">
                            <cms:CMSTextBox runat="server" ID="txtAction" />
                        </div>
                    </div>
                </asp:PlaceHolder>
            </div>
