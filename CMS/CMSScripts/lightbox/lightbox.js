...
Lightbox.prototype = {
    ...
    resizeImageContainer: function(imgWidth, imgHeight) {
        ...
        // Ensure correct space on the top of the image
        Element.setStyle('aspxoutput', {paddingTop: borderSize + 'px'});

        Element.setHeight('prevLink', heightNew);
        Element.setHeight('nextLink', heightNew);
