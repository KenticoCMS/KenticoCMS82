...
, panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	, spacing_closed: 8			// ditto - when pane is 'closed'
	, togglerLength_open: 48			// Length = WIDTH of toggler button on north/south sides - HEIGHT on east/west sides
	, togglerLength_closed: 48			// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
