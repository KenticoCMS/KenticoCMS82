cmsdefine(["require", "exports", 'CMS/NumberShortener', 'CMS/EventHub'], function(cmsrequire, exports, numberShortener, eventHub) {
        ...
        function Controller($scope, $compile, $element, $templateCache, $timeout, $animate, $q, liveTilePushService, $window) {
            ...
            */
            this.startLiveData = function () {
                ...
                if (!_this.$scope.tileModel.IsLiveTile || _this.$scope.isEditableMode) {
                    return;
                }

                _this.interval = _this.liveTilePushService.start(_this.$scope.tileModel.Guid, function (liveTile) {
            ...
            /**
            * Ends loading of the live data.
            */
            this.stopLiveData = function () {
                if (!_this.$scope.tileModel.IsLiveTile) {
                    return;
                }

                _this.liveTilePushService.stop(_this.interval);
            };
            /**
            ...
            */
            this.onClickOutside = function (e) {
                if (_this.getMainDataTileElement(angular.element(e.target)).data('guid') !== _this.$scope.tileModel.Guid) {
            ...
            */
            this.getMainDataTileElement = function (anyDom) {
                return anyDom.data('tile') === 'tile' ? anyDom : angular.element(anyDom.closest('[data-tile=tile]'));
            };
            /**
            ...
            */
            this.handleEditMode = function () {
                // If tile is in edited mode while initialization, handle the shrinking and stop live data loading
                if (_this.$scope.isEditableMode) {
                    _this.waitForShrink();
                    _this.stopLiveData();
                }
                ...
                eventHub.subscribe(_this.EDITABLE_MODE_CHANGED_EVENT, function (isEditableMode) {
                    ...
                    if (_this.$scope.isEditableMode) {
                        ...
                        _this.killTile();
                        _this.waitForShrink();
                        angular.element(_this.$window).on('mousedown', _this.onClickOutside);
                    } else {
                        angular.element(_this.$window).off('mousedown', _this.onClickOutside);
                        if (!_this.destroyed) {
                            _this.startLiveData();
                        }
                        if (_this.hasData) {
            ...
            */
            this.removeTile = function () {
                eventHub.publish('cms.applicationdashboard.ApplicationRemoved', _this.$scope.tileModel.Guid);
            };
            /**
            ...
            */
            this.killTile = function () {
                ...
                _this.$animate.removeClass(_this.wrapper, _this.LIVE_WRAPPER_CSS_CLASS, function () {
                    deferred.resolve();
                });
            ...
            */
            this.resurrectTile = function (useRandom) {
                ...
                _this.$timeout(function () {
                    ...
                    _this.$animate.addClass(_this.wrapper, _this.LIVE_WRAPPER_CSS_CLASS, function () {
            ...
            */
            this.refreshLiveTileData = function (liveTile) {
                _this.wrapper.append(_this.$compile(_this.$templateCache.get('liveTileTemplate.html'))(_this.$scope));
        ...
        '$parse', '$compile', '$templateCache', function ($parse, $compile, $templateCache) {
            var tile = {
                ...
                link: function (scope, element, attrs, controller) {
                    ...
                    element.html($templateCache.get('tileTemplate.html'));
