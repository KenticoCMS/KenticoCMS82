            ...
            <asp:Panel ID="PanelContent" runat="server" CssClass="PageContent">
                ...
                <asp:Panel runat="server" ID="pnlLicense" Visible="false">
                    <div  style="padding-top: 25px">
                        ...
                        <asp:HyperLink runat="server" ID="lnkFreeEdition" NavigateUrl="http://www.kenticoasia.com/download/free-edition.aspx">http://www.kenticoasia.com/download/free-edition.aspx</asp:HyperLink>
                    </div>
                </asp:Panel>
            </asp:Panel>
        </asp:Panel>
