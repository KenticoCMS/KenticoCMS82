    ...
    <div class="object-btowser">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="editing-form-value-cell macro-editor-form-control">
                    <cms:MacroEditor ID="editorElem" runat="server" Text="CMSContext.Current" SingleLineMode="true" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
