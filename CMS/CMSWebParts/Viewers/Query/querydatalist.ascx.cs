...
public partial class CMSWebParts_Viewers_Query_querydatalist : CMSAbstractWebPart
{
    ...
    public bool LoadPagesIndividually
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("LoadPagesIndividually"), lstItems.LoadPagesIndividually);
        }
        set
        {
            SetValue("LoadPagesIndividually", value);
            lstItems.LoadPagesIndividually = value;
        }
    }
    ...
    public bool ResolveDynamicControls
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("ResolveDynamicControls"), lstItems.ResolveDynamicControls);
        }
        set
        {
            SetValue("ResolveDynamicControls", value);
            lstItems.ResolveDynamicControls = value;
        }
    }
    ...
    public bool ShowDeleteButton
    {
        ...
        set
        {
            ...
            lstItems.ShowDeleteButton = value;
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        {
            // Add query data list to the filter collection
            CMSControlsHelper.SetFilter(ValidationHelper.GetString(GetValue("WebPartControlID"), ID), lstItems);

            // Setup the control
            lstItems.ControlContext = ControlContext;

            // Document properties
            lstItems.ResolveDynamicControls = ResolveDynamicControls;
            lstItems.LoadPagesIndividually = LoadPagesIndividually;
            ...
            lstItems.ShowDeleteButton = ShowDeleteButton;
            lstItems.ShowEditButton = ShowEditButton;
