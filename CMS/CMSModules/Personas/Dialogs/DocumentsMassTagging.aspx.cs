...
/// <summary>
/// Users selects personas on this dialog which should be assigned to or removed from the documents which were chosen before (on the document listing).
/// </summary>
public partial class CMSModules_Personas_Dialogs_DocumentsMassTagging : CMSModalPage
{
    ...
    /// <summary>
    /// Parameters which specifies information needed to perform action, such as which documents should be tagged. This hashtable is filled in DocumentListMassActionsExtender class.
    /// </summary>
