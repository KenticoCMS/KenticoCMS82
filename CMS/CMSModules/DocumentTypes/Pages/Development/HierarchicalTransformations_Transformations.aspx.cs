...
public partial class CMSModules_DocumentTypes_Pages_Development_HierarchicalTransformations_Transformations : CMSDesignPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!MembershipContext.AuthenticatedUser.IsAuthorizedPerUIElement("CMS.Design", new[] { "Design", "Design.WebPartProperties", "WebPartProperties.General", "WebPartProperties.EditTransformations" }, SiteContext.CurrentSiteName))
        {
