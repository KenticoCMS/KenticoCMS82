...
public partial class CMSModules_AdminControls_Controls_Class_FieldEditor_CSSsettings : CMSUserControl
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        txtFieldCssClass.IsLiveSite = IsLiveSite;
        txtCaptionCellCssClass.IsLiveSite = IsLiveSite;
        txtCaptionCssClass.IsLiveSite = IsLiveSite;
        txtCaptionStyle.IsLiveSite = IsLiveSite;
        txtControlCellCssClass.IsLiveSite = IsLiveSite;
        txtControlCssClass.IsLiveSite = IsLiveSite;
        txtInputStyle.IsLiveSite = IsLiveSite;
    }
