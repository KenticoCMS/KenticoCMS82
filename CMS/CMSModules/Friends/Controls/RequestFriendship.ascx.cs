...
public partial class CMSModules_Friends_Controls_RequestFriendship : CMSUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!StopProcessing)
        {
            string script = "function displayRequest_" + ClientID + "(){ \n" + "modalDialog('" + AuthenticationHelper.ResolveDialogUrl("~/CMSModules/Friends/CMSPages/Friends_Request.aspx") + "?userid=" + UserID + "&requestid= " + RequestedUserID + "' ,'requestFriend', 810, 460); \n} \n";
