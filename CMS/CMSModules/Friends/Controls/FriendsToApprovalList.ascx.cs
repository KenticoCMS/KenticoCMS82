...
public partial class CMSModules_Friends_Controls_FriendsToApprovalList : CMSAdminListControl
{
    ...
    protected string RejectDialogUrl
    {
        get
        {
            ...
            {
                mRejectDialogUrl = AuthenticationHelper.ResolveDialogUrl(dialogsUrl + "Friends_Reject.aspx") + "?userid=" + UserID;
            }
    ...
    protected string ApproveDialogUrl
    {
        get
        {
            ...
            {
                mApproveDialogUrl = AuthenticationHelper.ResolveDialogUrl(dialogsUrl + "Friends_Approve.aspx") + "?userid=" + UserID;
            }
