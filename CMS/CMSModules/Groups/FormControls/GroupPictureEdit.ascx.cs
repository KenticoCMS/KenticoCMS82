...
public partial class CMSModules_Groups_FormControls_GroupPictureEdit : FormEngineUserControl
{
    ...
    public bool KeepAspectRatio
    {
        ...
        set
        {
            GroupPicture.KeepAspectRatio = value;
        }
    }
    ...
    public GroupInfo GroupInfo
    {
        ...
        set
        {
            ...
            if (mGroupInfo != null)
            {
                GroupPicture.GroupID = mGroupInfo.GroupID;
    ...
    public int MaxSideSize
    {
        ...
        set
        {
            ...
            GroupPicture.KeepAspectRatio = true;
            mMaxSideSize = value;
        }
    }
    ...
    private void RegisterScripts()
    {
        ...
        if (IsLiveSite)
        {
            resolvedAvatarsPage = AuthenticationHelper.ResolveDialogUrl(AuthenticationHelper.IsAuthenticated() ? "~/CMSModules/Avatars/CMSPages/AvatarsGallery.aspx" : "~/CMSModules/Avatars/CMSPages/PublicAvatarsGallery.aspx");
        }
        else
        {
