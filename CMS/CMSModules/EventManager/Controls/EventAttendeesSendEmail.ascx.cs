...
public partial class CMSModules_EventManager_Controls_EventAttendeesSendEmail : CMSAdminControl
{
    ...
    protected void Send()
    {
        ...
        if (node != null && CMSString.Equals(node.NodeClassName, "cms.bookingevent", true))
        {
            ...
            macro[0, 1] = EventProvider.GetEventDateString(eventDate, eventEndDate, isAllDay, TimeZoneHelper.GetTimeZoneInfo(SiteContext.CurrentSite), SiteContext.CurrentSiteName);
            resolver.SetNamedSourceData(macro);
