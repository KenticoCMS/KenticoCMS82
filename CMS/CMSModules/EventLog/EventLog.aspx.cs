...
public partial class CMSModules_EventLog_EventLog : CMSEventLogPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        disabledModuleInfo.SettingsKeys = "CMSLogToDatabase";
        disabledModuleInfo.KeyScope = DisabledModuleScope.Global;
        disabledModuleInfo.InfoText = ResHelper.GetString("eventlog.disabledmodule");
