    ...
    <ContentTemplate>
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel ID="lblMonth" runat="server" CssClass="control-label" DisplayColon="true" EnableViewState="false" />
                </div>
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel ID="lblDay" runat="server" CssClass="control-label" DisplayColon="true" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel ID="lblTime" runat="server" CssClass="control-label" DisplayColon="true" EnableViewState="false" />
                </div>
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel ID="lblValue" runat="server" CssClass="control-label" DisplayColon="true" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
