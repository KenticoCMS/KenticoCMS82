...
<asp:Panel ID="pnlPreviewType" runat="server">
    <cms:JQueryTabContainer ID="pnlTabs" runat="server" CssClass="DialogElementHidden">
        ...
        <cms:JQueryTab ID="tabFlashGeneral" runat="server" CssClass="media-properties-tab">
            <ContentTemplate>
                <div class="FlashGeneralTab PageContent media-properties">
                    <div class="form-horizontal">
                        <asp:PlaceHolder ID="plcFlashUrl" runat="server">
                            <div class="form-group">
                                <div class="editing-form-label-cell media-dialog-label-cell">
                                    <cms:LocalizedLabel CssClass="control-label" ID="lblFlashUrl" runat="server" EnableViewState="false" DisplayColon="true"
                                        ResourceString="general.url" />
                                </div>
                                <div class="editing-form-value-cell media-dialog-value-cell">
                                    <cms:CMSUpdatePanel ID="pnlFlashUrl" runat="server">
                                        <ContentTemplate>
                                            <cms:CMSTextBox ID="txtFlashUrl" runat="server" CssClass="media-url-control" />
                                            <cms:CMSAccessibleButton ID="imgFlashRefresh" IconCssClass="icon-rotate-right cms-icon-80" IconOnly="true" runat="server" />
                                        </ContentTemplate>
                                    </cms:CMSUpdatePanel>
                                </div>
                            </div>
                        ...
                        <div class="properties">
                            <cms:WidthHeightSelector ID="flashWidthHeightElem" runat="server" ShowLabels="true" TextBoxesClass="input-width-20"
                                Locked="false" />
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                    <cms:LocalizedLabel CssClass="control-label" ID="lblFlashAutoplay" runat="server" ResourceString="dialogs.vid.autoplay"
                                        EnableViewState="false" DisplayColon="true" AssociatedControlID="chkFlashAutoplay" />
                                </div>
                                <div class="editing-form-value-cell">
                                    <cms:CMSCheckBox ID="chkFlashAutoplay" runat="server" Checked="true" EnableViewState="false" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                    <cms:LocalizedLabel CssClass="control-label" ID="lblFlashLoop" runat="server" ResourceString="dialogs.vid.loop"
                                        EnableViewState="false" DisplayColon="true" AssociatedControlID="chkFlashLoop" />
                                </div>
                                <div class="editing-form-value-cell">
                                    <cms:CMSCheckBox ID="chkFlashLoop" runat="server" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                    <cms:LocalizedLabel CssClass="control-label" ID="lblFlashEnableMenu" runat="server" ResourceString="dialogs.flash.enablemenu"
                                        EnableViewState="false" DisplayColon="true" AssociatedControlID="chkFlashEnableMenu" />
                                </div>
                                <div class="editing-form-value-cell">
                                    <cms:CMSCheckBox ID="chkFlashEnableMenu" runat="server" />
                                </div>
                            </div>
                        </div>
                        <div class="preview">
                            <div class="DialogPropertiesPreview DialogMediaPreview">
                                <cms:CMSUpdatePanel ID="pnlFlashPreview" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="btnFlashPreview" CssClass="HiddenButton" runat="server" EnableViewState="false" />
        ...
        <cms:JQueryTab ID="tabFlashAdvanced" runat="server" CssClass="media-properties-tab">
            <ContentTemplate>
                <div class="FlashAdvancedTab PageContent media-properties">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <div class="editing-form-label-cell media-dialog-label-cell">
                                <cms:LocalizedLabel CssClass="control-label" ID="lblFlashScale" runat="server" EnableViewState="false" ResourceString="dialogs.flash.scale"
                                    DisplayColon="true" AssociatedControlID="drpFlashScale" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:CMSDropDownList ID="drpFlashScale" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="editing-form-label-cell media-dialog-label-cell">
                                <cms:LocalizedLabel CssClass="control-label" ID="lblFlashId" runat="server" EnableViewState="false" ResourceString="dialogs.advanced.id"
                                    DisplayColon="true" AssociatedControlID="txtFlashId" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:CMSTextBox runat="server" ID="txtFlashId" EnableViewState="false" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="editing-form-label-cell media-dialog-label-cell">
                                <cms:LocalizedLabel CssClass="control-label" ID="lblFlashTitle" runat="server" EnableViewState="false" ResourceString="dialogs.flash.advisorytitle"
                                    DisplayColon="true" AssociatedControlID="txtFlashTitle" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:CMSTextBox runat="server" ID="txtFlashTitle" EnableViewState="false" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="editing-form-label-cell media-dialog-label-cell">
                                <cms:LocalizedLabel CssClass="control-label" ID="lblFlashClass" runat="server" EnableViewState="false" ResourceString="dialogs.advanced.class"
                                    DisplayColon="true" AssociatedControlID="txtFlashClass" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:CMSTextBox runat="server" ID="txtFlashClass" EnableViewState="false" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="editing-form-label-cell media-dialog-label-cell">
                                <cms:LocalizedLabel CssClass="control-label" ID="lblFlasVars" runat="server" EnableViewState="false" ResourceString="dialogs.advanced.flashvars"
                                    DisplayColon="true" AssociatedControlID="txtFlashVars" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:CMSTextBox runat="server" ID="txtFlashVars" EnableViewState="false" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="editing-form-label-cell media-dialog-label-cell">
                                <cms:LocalizedLabel CssClass="control-label" ID="lblFlashStyle" runat="server" EnableViewState="false" ResourceString="dialogs.advanced.style"
                                    DisplayColon="true" AssociatedControlID="txtFlashStyle" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:CMSTextArea runat="server" ID="txtFlashStyle" EnableViewState="false" />
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
