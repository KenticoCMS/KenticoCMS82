...
public partial class CMSModules_SocialMarketing_FormControls_LinkedInCompanyAccessToken : FormEngineUserControl
{
    ...
    public override void LoadOtherValues()
    {
        ...
        if (ContainsColumn("LinkedInAccountAccessTokenSecret"))
        {
            hdnTokenSecret.Value = ValidationHelper.GetString(GetColumnValue("LinkedInAccountAccessTokenSecret"), "");
        }
    ...
    public override object[,] GetOtherValues()
    {
        ...
        return new object[,]
        {
            ...
            { "LinkedInAccountAccessTokenSecret", hdnTokenSecret.Value },
    ...
    private void InitControl()
    {
        ...
        if (!RequestHelper.IsPostBack())
        {
            if ((LinkedInAccount != null) && (LinkedInAccount.LinkedInAccountID > 0))
            {
                ...
                hdnTokenSecret.Value = LinkedInAccount.LinkedInAccountAccessTokenSecret;
        ...
        ScriptHelper.RegisterModule(Page, "CMS.SocialMarketing/LinkedInCompanyAccessToken", new
        {
            ...
            tokenSecretControlId = hdnTokenSecret.ClientID,
    ...
    private bool ValidateToken()
    {
        ...
        if (!String.IsNullOrEmpty(hdnToken.Value) && !String.IsNullOrEmpty(hdnTokenSecret.Value))
        {
            return true;
        }
