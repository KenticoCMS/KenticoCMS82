...
/// </remarks>
public partial class CMSModules_SocialMedia_FormControls_Facebook_Mapping : FormEngineUserControl, ICallbackEventHandler
{
    ...
    {
        base.OnLoad(e);
        string baseUrl = URLHelper.ResolveUrl("~/CMSModules/SocialMedia/Pages/Facebook/MappingEditor.aspx");
