<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MappingEditor.aspx.cs" Inherits="CMSModules_SocialMedia_Pages_Facebook_MappingEditor" MasterPageFile="~/CMSMasterPages/UI/Dialogs/ModalDialogPage.master" EnableEventValidation="false" Theme="Default" %>
...
<%@ Register TagPrefix="cms" TagName="MappingEditorItem" Src="~/CMSModules/SocialMedia/Controls/Facebook/MappingEditorItem.ascx" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="plcContent" runat="Server" EnableViewState="false">
    ...
    <asp:Panel ID="MappingPanel" runat="server" EnableViewState="false" CssClass="Hidden">
        ...
        <cms:AlertLabel runat="server" AlertType="Warning" ResourceString="fb.mapping.warning"></cms:AlertLabel>
    </asp:Panel>
