...
public partial class CMSModules_ContactManagement_FormControls_DataCom_ContactMapping : FormEngineUserControl, ICallbackEventHandler
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        string script = String.Format("function DataCom_EditContactMapping (arg, context) {{ modalDialog('{0}', 'EditContactMapping', '770', '700', null); return false; }}", URLHelper.AddParameterToUrl(url, "hash", QueryHelper.GetHash(url)));
