        ...
        if (!MembershipContext.AuthenticatedUser.IsPublic())
        {
            ...
            if (QueryHelper.GetString("showtab", String.Empty).ToLowerCSafe() != "search")
            {
                ...
                CurrentMaster.Tabs.AddTab(new UITabItem()
                {
                    ...
                    RedirectUrl = AuthenticationHelper.ResolveDialogUrl("~/CMSModules/Messaging/CMSPages/MessageUserSelector_ContactList.aspx") + "?hidid=" +
                ...
                if (ModuleManager.IsModuleLoaded(ModuleName.COMMUNITY) && UIHelper.IsFriendsModuleEnabled(SiteContext.CurrentSiteName))
                {
                    ...
                    CurrentMaster.Tabs.AddTab(new UITabItem()
                    {
                        ...
                        RedirectUrl = AuthenticationHelper.ResolveDialogUrl("~/CMSModules/Friends/CMSPages/MessageUserSelector_FriendsList.aspx") + "?hidid=" +
                                     QueryHelper.GetText("hidid", String.Empty) +
                                     "&mid=" +
                                     QueryHelper.GetText("mid", String.Empty),
                    });
            ...
            CurrentMaster.Tabs.AddTab(new UITabItem()
            {
                ...
                RedirectUrl = AuthenticationHelper.ResolveDialogUrl("~/CMSModules/Messaging/CMSPages/MessageUserSelector_Search.aspx") + "?refresh=" +
