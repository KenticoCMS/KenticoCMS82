            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ResourceString="Customer_Edit_Address_Edit.lblPersonalName" runat="server" ID="lblPersonalName" EnableViewState="false" />
                    </div>
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ResourceString="Customer_Edit_Address_Edit.AddressLine1Label" runat="server" ID="lblAddressLine1" EnableViewState="false" />
                    </div>
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ResourceString="Customer_Edit_Address_Edit.AddressCityLabel" runat="server" ID="lblAddressCity" EnableViewState="false" />
                    </div>
                    <div class="editing-form-value-cell">
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ResourceString="Customer_Edit_Address_Edit.AddressZipLabel" runat="server" ID="lblAddressZip" EnableViewState="false" />
                    </div>
                    <div class="editing-form-value-cell">
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ResourceString="Customer_Edit_Address_Edit.AddressCountryIDLabel" runat="server" ID="lblAddressCountry" EnableViewState="false" />
                    </div>
                    <div class="editing-form-value-cell">
