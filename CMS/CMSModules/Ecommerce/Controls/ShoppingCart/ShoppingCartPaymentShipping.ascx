    ...
    <div class="form-horizontal">
        ...
        <asp:PlaceHolder ID="plcPayment" runat="server">
            <div class="form-group">
                ...
                <div class="editing-form-value-cell">
                    <cms:PaymentSelector ID="selectPayment" runat="server" AutoPostBack="true" IsLiveSite="false" AddAllItemsRecord="false" UseNameForSelection="false" OnChanged="selectPayment_Changed" />
                </div>
            </div>
        </asp:PlaceHolder>
    </div>
