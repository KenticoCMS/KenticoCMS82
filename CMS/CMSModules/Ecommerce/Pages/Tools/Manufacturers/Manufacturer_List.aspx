...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:CMSUpdatePanel ID="pnlUpdate" runat="server">
        <ContentTemplate>
            <cms:UniGrid runat="server" ID="UniGrid" IsLiveSite="false" Columns="ManufacturerID, ManufacturerDisplayName, ManufacturerEnabled, ManufacturerSiteID, ManufacturerIsImportant"
                ...
                <GridColumns>
                    ...
                    <ug:Column Source="ManufacturerIsImportant" ExternalSourceName="#yesno" Name="ManufacturerIsImportant"
                        Caption="$com.isimportant$" Wrap="false" />
