...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:UniGrid runat="server" ID="gridElem" OrderBy="StatusOrder" IsLiveSite="false"
        ...
        <GridActions>
            ...
            <ug:Action Name="moveup" Caption="$General.MoveUp$" FontIconClass="icon-chevron-up" />
            <ug:Action Name="movedown" Caption="$General.MoveDown$" FontIconClass="icon-chevron-down" />
        </GridActions>
        <GridColumns>
