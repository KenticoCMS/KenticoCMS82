...
<cms:UniGrid ID="gridElem" runat="server" OnOnAction="gridElem_OnOnAction" OrderBy="ABTestStatus"
    ...
    <GridActions Parameters="ABTestID">
        ...
        <ug:Action Name="delete" Caption="$general.delete$" FontIconClass="icon-bin" FontIconStyle="Critical" Confirmation="$general.confirmdelete$" CommandArgument="ABTestID" ModuleName="cms.abtest" Permissions="Manage" />
    </GridActions>
    <GridColumns>
        <ug:Column Source="ABTestDisplayName" Caption="$abtesting.testname$" Wrap="false" CssClass="main-column-100" />
        <ug:Column Source="ABTestOriginalPage" Caption="$abtesting.page$" Wrap="false" ExternalSourceName="page"/>
        ...
        <ug:Column Source="ABTestName" Caption="$abtesting.visitortotal$" Wrap="false" ExternalSourceName="visitors" AllowSorting="false"/>
        <ug:Column Source="ABTestName" Caption="$abtesting.conversiontotal$" Wrap="false" ExternalSourceName="conversions" AllowSorting="false"/>
